...
public enum GeneralErrorCode {
    ...
    ALREADY_ANNOUNCED(HttpStatus.CONFLICT, "모집 공고 결과 발표가 이미 완료되었습니다."),
    RECRUITMENT_ALREADY_STARTED(HttpStatus.CONFLICT, "모집이 이미 시작되었습니다."),
    RECRUITMENT_NOT_STARTED(HttpStatus.CONFLICT, "모집이 시작되지 않았습니다."),
