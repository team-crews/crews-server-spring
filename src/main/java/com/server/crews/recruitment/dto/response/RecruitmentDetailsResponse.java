...
public record RecruitmentDetailsResponse(
        String title, String description, Progress progress, List<Section> sections, LocalDateTime deadline) {
    public static RecruitmentDetailsResponse from(final Recruitment recruitment) {
        return new RecruitmentDetailsResponse(
                ...
                recruitment.getProgress(), recruitment.getSections(), recruitment.getDeadline());
    }
}
