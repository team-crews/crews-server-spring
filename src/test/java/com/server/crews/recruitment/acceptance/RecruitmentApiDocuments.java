...
public class RecruitmentApiDocuments {
    ...
    public static RestDocumentationFilter RECRUITMENT_SAVE_200_REQUEST_DOCUMENT() {
        return document("모집 공고 저장 API",
                requestFields(
                        ...
                        fieldWithPath(".closingDate").description("모집 마감일"),
                        fieldWithPath(".sections").description("섹션 목록").optional(),
                        ...
                        fieldWithPath(".sections[].questions").description("질문 목록").optional(),
                        ...
                        fieldWithPath(".sections[].questions[].wordLimit").description("NARRATIVE 질문의 글자 수 제한").optional(),
                        fieldWithPath(".sections[].questions[].minimumSelection").description("SELECTIVE 질문의 최소 선택 개수").optional(),
                        fieldWithPath(".sections[].questions[].maximumSelection").description("SELECTIVE 질문의 최대 선택 개수").optional(),
                        fieldWithPath(".sections[].questions[].choices").description("SELECTIVE 질문의 선택지 목록").optional().optional(),
                        fieldWithPath(".sections[].questions[].choices[].id").description("선택지 id (최초 저장이 아닐 경우 필요함)").optional(),
