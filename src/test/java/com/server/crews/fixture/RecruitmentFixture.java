...
public class RecruitmentFixture {
    ...
    public static final QuestionSaveRequest NARRATIVE_QUESTION_REQUEST = new QuestionSaveRequest(null,
            QuestionType.NARRATIVE.name(), INTRODUCTION_QUESTION, true, 1, 100, null, null, List.of());
    public static final QuestionSaveRequest SELECTIVE_QUESTION_REQUEST = new QuestionSaveRequest(null,
            QuestionType.SELECTIVE.name(), STRENGTH_QUESTION, true, 2, null, 1, 2, STRENGTH_CHOICES_REQUEST);
    public static final List<QuestionSaveRequest> QUESTION_REQUESTS = List.of(NARRATIVE_QUESTION_REQUEST,
            SELECTIVE_QUESTION_REQUEST);
    public static final SectionSaveRequest BACKEND_SECTION_REQUEST = new SectionSaveRequest(null, BACKEND_SECTION_NAME,
            DEFAULT_DESCRIPTION, QUESTION_REQUESTS);
    public static final SectionSaveRequest FRONTEND_SECTION_REQUEST = new SectionSaveRequest(null,
            FRONTEND_SECTION_NAME, DEFAULT_DESCRIPTION, QUESTION_REQUESTS);
    public static final List<SectionSaveRequest> SECTION_REQUESTS = List.of(BACKEND_SECTION_REQUEST,
            FRONTEND_SECTION_REQUEST);
    public static final RecruitmentSaveRequest RECRUITMENT_SAVE_REQUEST = new RecruitmentSaveRequest(null,
            DEFAULT_TITLE, DEFAULT_DESCRIPTION, SECTION_REQUESTS, DEFAULT_DEADLINE.toString());
